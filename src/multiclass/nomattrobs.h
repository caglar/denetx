...
class NomAttrObserver : public AttributeClassObserver
{
  ...
  public:
          ...
          totalWeightObserved(0), missingWeightObserved(0), binaryOnly(false)
    {
      ...
      float
          getMissingWeightsObserved()
          {
              return this->missingWeightObserved;
          }

      void
          addMissingWeightsObserved(float missingWeightsObserved)
          {
              this->missingWeightObserved += missingWeightsObserved;
          }
      ...
      void
          addTotalClassWeightsObserved(float totalClassWeightsObserved)
          {
              this->totalWeightObserved += totalClassWeightsObserved;
          }
