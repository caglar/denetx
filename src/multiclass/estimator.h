...
namespace est
{
    ...
    class NormalEstimator : Estimator
    {
      ...
      public:
           ...
           */
          explicit NormalEstimator(float precision)
          {
          ...
          float
              ...
              {
                float lessThanWeight = mStandardDev > 0.0 ? (normalProbability((val - mMean) / mStandardDev) * mSumOfWeights): (mSumOfWeights - equalToWeight);
          ...
          float
              ...
              {
                float greaterThanWeight = mSumOfWeights - equalToWeight - lessThanWeight;
    ...
    class KernelEstimator : Estimator
    {
      ...
      public:
          explicit KernelEstimator(float precision)
          {
    ...
    class DiscreteEstimator : Estimator
    {
      ...
      public:
          explicit DiscreteEstimator(int noOfSymbols)
          {
